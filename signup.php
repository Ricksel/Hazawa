    ...
    <div class="container">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="text" id="lotBlockInput" name="lotBlockInput" class="form-control" placeholder="833">
            </div>
            <div class="form-group col-md-4">
                <label for="streetInput">Street:</label>
                <input type="text" id="streetInput" name="streetInput" class="form-control" placeholder="Sisa St.">
            </div>
            <div class="form-group col-md-4">
                <label for="phaseInput">Phase/Subdivision:</label>
                <input type="text" id="phaseInput" name="phaseInput" class="form-control" placeholder="BF Homes">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="email" id="emailInput" class="form-control" placeholder="juandelacruz12@email.com">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" id="repeatPasswordInput" name="repeatPasswordInput" class="form-control" placeholder="Repeat Password">
            </div>
        </div>
